...
LOAD DATA LOCAL INFILE 'accounts_scale_data.txt' INTO TABLE account_account COLUMNS TERMINATED BY ';';
LOAD DATA LOCAL INFILE 'holdings_scale_data.txt' INTO TABLE account_holding COLUMNS TERMINATED BY ';';
GO